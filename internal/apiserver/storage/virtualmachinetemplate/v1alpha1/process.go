...
type V1alpha1ProcessREST struct {
	client    templateclient.Interface
	processor virtualmachinetemplate.Processor
}

func NewV1alpha1ProcessREST(client templateclient.Interface) *V1alpha1ProcessREST {
	return &V1alpha1ProcessREST{
		client:    client,
...
var (
	_ = rest.Storage(&V1alpha1ProcessREST{})
	_ = rest.Connecter(&V1alpha1ProcessREST{})
)

func (p *V1alpha1ProcessREST) New() runtime.Object {
	return &subresourcesv1alpha1.ProcessedVirtualMachineTemplate{}
}

func (p *V1alpha1ProcessREST) Destroy() {}

func (p *V1alpha1ProcessREST) Connect(ctx context.Context, id string, _ runtime.Object, r rest.Responder) (http.Handler, error) {
...
func (p *V1alpha1ProcessREST) NewConnectOptions() (options runtime.Object, include bool, path string) {
	return nil, false, ""
}

func (p *V1alpha1ProcessREST) ConnectMethods() []string {
	return []string{http.MethodPost}
}

func convertProcessedToV1alpha1(
	in *subresourcesv1beta1.ProcessedVirtualMachineTemplate,
	...
	out.APIVersion = subresourcesv1alpha1.GroupVersion.String()
	return out, nil
}
