...
var (
	_ = rest.Storage(&V1beta1CreateREST{})
	_ = rest.Connecter(&V1beta1CreateREST{})
)

func (c *V1beta1CreateREST) New() runtime.Object {
	return &subresourcesv1beta1.ProcessedVirtualMachineTemplate{}
}

func (c *V1beta1CreateREST) Destroy() {}

func (c *V1beta1CreateREST) Connect(ctx context.Context, id string, _ runtime.Object, r rest.Responder) (http.Handler, error) {
	...
	return http.HandlerFunc(func(_ http.ResponseWriter, req *http.Request) {
		klog.V(virtualmachinetemplate.DebugLogLevel).Infof("POST /create for VirtualMachineTemplate %s/%s", ns, id)
...
func (c *V1beta1CreateREST) NewConnectOptions() (options runtime.Object, include bool, path string) {
	return nil, false, ""
}

func (c *V1beta1CreateREST) ConnectMethods() []string {
