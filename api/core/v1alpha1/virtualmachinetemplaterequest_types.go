...
type VirtualMachineTemplateRequestSpec struct {
	...
	// +required
	VirtualMachineRef *VirtualMachineReference `json:"virtualMachineRef,omitempty,omitzero" protobuf:"bytes,1,name=virtualMachineRef"`
...
func (r *VirtualMachineReference) IsZero() bool {
	return r == nil || (r.Namespace == "" && r.Name == "")
}
